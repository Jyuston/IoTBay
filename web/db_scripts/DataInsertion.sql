...
VALUES ('john.smith@gmail.com', 'John', 'Smith', '0438 278 971', 'C', 'password123', true),
       ...
       ('craig.e@iderat.edu', 'Craig', 'Estrada', '0438 278 973', 'C', 'password123', true),
       ('Judahs.e@hotmail.org', 'Judah', 'Erickson', '0438 278 975', 'C', 'password123', true),
       ('Hakeem@augue.org', 'Hakeem', 'Townsend', '0493 750 271', 'C', 'password123', true),
       ('Leroy@Donecnibh.org', 'Leroy', 'Hoffman', '0438 278 976', 'C', 'password123', true),
       ('Zachery@vestibulum.com', 'Zachery', 'Acosta', '0438 278 977', 'C', 'password123', true),
       ('Upton@malesuadafames.edu', 'Upton', 'Phelps', '0438 278 978', 'C', 'password123', true),
       ('barrett.lewis@utnullaCras.net', 'Barrett', 'Lewis', '0438 278 979', 'C', 'password123', true),
       ('Stuart@test.com', 'Stuart', 'Kramer', '0438 278 980', 'C', 'password123', true),
       ('Tyler@Morbinon.edu', 'Tyler', 'Owens', '0438 278 981', 'C', 'password123', true),
...
VALUES (1, '5244 8746 5799 2270', '832', '04', '2021'),
       ...
       (19, '523 09152 33392 111', '908', '04', '2021'),
       (20, '523 09152 33392 222', '908', '04', '2021')
;
