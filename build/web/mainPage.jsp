...
<html>
    ...
    <%
        ...
        String entranceMethod = (String)session.getAttribute("entranceMethod");
    %>
    <body>
        <div class="container">        
            <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light" style="background-color: #e3f2fd;">
                ...
                <div class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <% if (entranceMethod.equals("registration")) { %>
                        <a class="nav-item nav-link" href="editInfo.jsp">Edit Your Details</a>
                    <% } %>
                </div>
            ...
            <div class="row">
                ...
                <% if (entranceMethod.equals("registration")) { %>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-light">
                                        <th scope="row"></th>
                                        <td>CVC</td>
                                        <td>${customer.customerPaymentInfo.cvc}</td>
                                    </tr>                            
                                    <tr class="table-light">
                                        <th scope="row"></th>
                    ...
                    %>
                        <div class="col-6">
                            <h1>Welcome, <%= email %>!</h1>                  
                            <p>You haven't told us much about yourself...</p>
                        </div>
                    <% } %>                
